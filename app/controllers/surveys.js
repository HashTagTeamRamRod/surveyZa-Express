...
const update = (req, res, next) => {
  ...
  const Survey = req.params.id.findById('id')
  const question = Object.assign(req.body.survey, {
    questions: req.body.survey.questions
  })
  console.log('survey.questions is ', Survey.questions)
  Survey.questions.push(question)
  console.log('req.body.survey.questions is ', req.body.survey.questions)
  req.survey.questions.push(req.body.survey)
